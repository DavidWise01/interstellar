...
def _card(p):
    em=p.get("emergence","natural"); col=NATURES.get(em,("#cdd6e4",""))[0]
    rec={"name":p["name"],"seal":p.get("epithet",""),"origin":"INT · Interstellar","axiom":"INT"}
...
<style>
:root{--void:#05070d;--void2:#0b0f18;--void3:#111722;--ice:#e9eef5;--ice2:#9aa8bc;--gold:#e8b54a;--blue:#6a9cd0;--teal:#7fd6c0;
